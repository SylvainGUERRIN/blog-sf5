 ...
 */
final class Version20191129084632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD post_created_at DATETIME NOT NULL, ADD post_modified_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP post_created_at, DROP post_modified_at');
